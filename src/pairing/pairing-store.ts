...
// GoClaw fork: drop a pending pairing request without granting allowFrom.
// Mirrors approveChannelPairingCode but skips the allow-list grant so the
// platform dashboard can decline pairing codes.
